...
\begin{itemize}
  ...
  \item 项目整体采用Django框架，后端使用Python实现
\end{itemize}
\end{onehalfspacing}

\datedsubsection{\textbf{看板项目 Web项目}}{2017 年6月 -- 8月}
\role{jsp+CSS+JavaScript, Java}  {实习}
\begin{onehalfspacing}
\begin{itemize}
...
\begin{itemize}
  ...
  \item 整体采用MVC架构，jsp实现view层，Servlet实现controller层。jsp通过AJAX异步提交请求到Servlet，Servlet负责相应请求产生的数据，把数据带给jsp。
\end{itemize}
\end{onehalfspacing}
